...
TEXTS = {
    "ru": {
        ...
        "enter_income_source": "Откуда поступили деньги? (например: от клиента, личные, займ и т.д.)",
        "enter_expense_purpose": "На что потрачены деньги? (например: аренда, зарплата, личные и т.д.)",
        "cash_history_btn": "📋 История кассы",
        "cash_history_title": "📋 История прихода/расхода кассы",
        ...
        "loan_status_active": "🔴",
        "loan_status_done": "✅",
        "loan_edit": "✏️ Изменить сумму",
        "loan_delete": "🗑 Удалить займ",
        "select_loan_for_edit": "Выберите займ для изменения:",
        "enter_new_loan_amount": "Введите новую сумму займа (было: {old_amount} {currency}):",
        "loan_amount_updated": "✅ Сумма займа изменена: {old_amount} → {new_amount} {currency}\nОстаток долга: {remaining} {currency}\nКасса скорректирована автоматически.",
        "confirm_delete_loan": "⚠️ Удалить займ {name} на {amount} {currency}?\nКасса будет скорректирована (списан текущий остаток долга {remaining} {currency}).",
        "confirm_yes": "✅ Да, удалить",
        "confirm_no": "❌ Отмена",
        "loan_deleted": "✅ Займ удалён. Касса скорректирована.",
        ...
        "lot_edit_agreed": "✏️ Изменить согласованную сумму",
        "lot_edit_received": "✏️ Изменить полученную сумму",
        "lot_delete": "🗑 Удалить лот",
        "expense_edit_choose": "Выберите расход для изменения:",
        "expense_edit_or_delete": "Что сделать с расходом «{category}: {amount} {currency}»?",
        "expense_edit_amount_btn": "✏️ Изменить сумму",
        "expense_delete_btn": "🗑 Удалить",
        "enter_new_expense_amount": "Введите новую сумму (было: {old_amount} {currency}):",
        "expense_amount_updated": "✅ Сумма расхода изменена: {old_amount} → {new_amount} {currency}. Касса скорректирована.",
        "expense_deleted": "✅ Расход удалён, сумма возвращена в кассу.",
    ...
    "uz": {
        ...
        "enter_income_source": "Pul qaerdan tushdi? (masalan: klientdan, shaxsiy, qarz va h.k.)",
        "enter_expense_purpose": "Pul nimaga ishlatildi? (masalan: ijara, maosh, shaxsiy va h.k.)",
        "cash_history_btn": "📋 Kassa tarixi",
        "cash_history_title": "📋 Kassa kirim/chiqim tarixi",
        ...
        "loan_status_active": "🔴",
        "loan_status_done": "✅",
        "loan_edit": "✏️ Summani o'zgartirish",
        "loan_delete": "🗑 Qarzni o'chirish",
        "select_loan_for_edit": "O'zgartirish uchun qarzni tanlang:",
        "enter_new_loan_amount": "Yangi qarz summasini kiriting (avvalgisi: {old_amount} {currency}):",
        "loan_amount_updated": "✅ Qarz summasi o'zgartirildi: {old_amount} → {new_amount} {currency}\nQarz qoldig'i: {remaining} {currency}\nKassa avtomatik tuzatildi.",
        "confirm_delete_loan": "⚠️ {name} ning {amount} {currency} qarzini o'chirasizmi?\nKassa tuzatiladi (joriy qoldiq {remaining} {currency} hisobdan chiqariladi).",
        "confirm_yes": "✅ Ha, o'chirish",
        "confirm_no": "❌ Bekor qilish",
        "loan_deleted": "✅ Qarz o'chirildi. Kassa tuzatildi.",
        ...
        "lot_edit_agreed": "✏️ Kelishilgan summani o'zgartirish",
        "lot_edit_received": "✏️ Olingan summani o'zgartirish",
        "lot_delete": "🗑 Lotni o'chirish",
        "expense_edit_choose": "O'zgartirish uchun xarajatni tanlang:",
        "expense_edit_or_delete": "«{category}: {amount} {currency}» xarajati bilan nima qilamiz?",
        "expense_edit_amount_btn": "✏️ Summani o'zgartirish",
        "expense_delete_btn": "🗑 O'chirish",
        "enter_new_expense_amount": "Yangi summani kiriting (avvalgisi: {old_amount} {currency}):",
        "expense_amount_updated": "✅ Xarajat summasi o'zgartirildi: {old_amount} → {new_amount} {currency}. Kassa tuzatildi.",
        "expense_deleted": "✅ Xarajat o'chirildi, summa kassaga qaytarildi.",
