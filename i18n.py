...
def t(lang: str, key: str, **kwargs) -> str:
    ...
    return template        "exchange_rate": "Введите курс обмена (сколько UZS за 1 USD):",
        "exchange_done": "✅ Обмен выполнен: {from_amt} {from_cur} → {to_amt:.2f} {to_cur} (курс {rate})",
        ...
        "lot_list_open": "🟡 Открытые лоты",
        "lot_list_closed": "✅ Закрытые лоты",
        "enter_lot_name": "Введите название/номер лота:",
        "enter_lot_purchase_price": "Введите сумму покупки лота:",
        "lot_created": "✅ Лот «{name}» создан!\nПокупка: {amount} {currency}\nСтатус: 🟡 Открыт",
        "no_lots": "Пока нет лотов.",
        "select_lot": "Выберите лот:",
        "lot_detail": (
            "📦 Лот: {name}\n"
            "Статус: {status}\n"
            "Дата создания: {date}\n\n"
            "💵 Покупка: {purchase:.2f} {currency}\n"
            "📉 Расходы: {expenses:.2f} {currency}\n"
            "━━━━━━━━━━━━\n"
            "Итого вложено: {total:.2f} {currency}\n"
        ),
        "lot_detail_closed_extra": (
            "\n💰 Продано за: {sale:.2f} {currency}\n"
            "📈 Прибыль: {profit:.2f} {currency}\n"
        ),
        "lot_add_expense": "➕ Добавить расход",
        "lot_view_expenses": "📋 Список расходов",
        ...
        "status_closed": "✅ Закрыт",
        "status_updated": "✅ Статус обновлён: {status}",
        "enter_sale_price": "Введите сумму продажи лота:",
        "lot_closed_result": (
            "🎉 Лот «{name}» закрыт!\n\n"
            "Покупка + расходы: {cost:.2f} {currency}\n"
            "Продажа: {sale:.2f} {currency}\n"
            "━━━━━━━━━━━━\n"
            "📈 Прибыль: {profit:.2f} {currency}\n\n"
            "Не забудь занести приход в Кассу через раздел 💰 Касса → Пополнить."
        ),
    ...
    "uz": {
        ...
        "lot_list_open": "🟡 Ochiq lotlar",
        "lot_list_closed": "✅ Yopilgan lotlar",
        "enter_lot_name": "Lot nomi/raqamini kiriting:",
        "enter_lot_purchase_price": "Lot xarid summasini kiriting:",
        "lot_created": "✅ «{name}» loti yaratildi!\nXarid: {amount} {currency}\nHolat: 🟡 Ochiq",
        "no_lots": "Hozircha lotlar yo'q.",
        "select_lot": "Lotni tanlang:",
        "lot_detail": (
            "📦 Lot: {name}\n"
            "Holat: {status}\n"
            "Yaratilgan sana: {date}\n\n"
            "💵 Xarid: {purchase:.2f} {currency}\n"
            "📉 Xarajatlar: {expenses:.2f} {currency}\n"
            "━━━━━━━━━━━━\n"
            "Jami sarflangan: {total:.2f} {currency}\n"
        ),
        "lot_detail_closed_extra": (
            "\n💰 Sotildi: {sale:.2f} {currency}\n"
            "📈 Foyda: {profit:.2f} {currency}\n"
        ),
        "lot_add_expense": "➕ Xarajat qo'shish",
        "lot_view_expenses": "📋 Xarajatlar ro'yxati",
        ...
        "status_closed": "✅ Yopilgan",
        "status_updated": "✅ Holat yangilandi: {status}",
        "enter_sale_price": "Lot sotuv summasini kiriting:",
        "lot_closed_result": (
            "🎉 «{name}» loti yopildi!\n\n"
            "Xarid + xarajatlar: {cost:.2f} {currency}\n"
            "Sotuv: {sale:.2f} {currency}\n"
            "━━━━━━━━━━━━\n"
            "📈 Foyda: {profit:.2f} {currency}\n\n"
            "Tushumni Kassaga qo'shishni unutmang: 💰 Kassa → To'ldirish."
        ),
